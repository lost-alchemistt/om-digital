...
const BirthdayScrollar: React.FC = () => {
  ...
  const supabaseStorageUrl = 'https://fgwmzwguyklmonwgzxop.supabase.co/storage/v1/object/public/Photos/Birthday';
...
export default BirthdayScrollar;